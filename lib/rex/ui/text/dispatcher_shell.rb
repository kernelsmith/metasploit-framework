...
module DispatcherShell
	...
	module CommandDispatcher
		...
		# Provide some convenience and normalization methods for tab completion of various kinds
		####################
		#
		# tab complete filenames given +str+ as the word currently being typed and +words+ array
